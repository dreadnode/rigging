...
#   pydantic.errors.PydanticUserError: `Message` is not fully defined; you should define `Model`,
#   then call `Message.model_rebuild()`.
from litellm.types.utils import ChatCompletionMessageToolCall  # noqa: TCH002
