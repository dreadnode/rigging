...
class Chat:
    """A chat object that contains a list of messages and a list of next messages. The next messages are messages that
    are generated by the generator and are not part of the original chat. This object is used to keep track of the
    conversation and generate new messages based on the current state of the conversation.
    """
    def __init__(
        self,
        messages: Messages,
