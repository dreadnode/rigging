...
[![Tests](https://github.com/organization/python-template/actions/workflows/tests.yaml/badge.svg)](https://github.com/organization/python-template/actions/workflows/tests.yaml)
[![Pre-Commit](https://github.com/organization/python-template/actions/workflows/pre-commit.yaml/badge.svg)](https://github.com/organization/python-template/actions/workflows/pre-commit.yaml)
...
The project uses MkDocs for documentation with automated builds via pre-commit
hooks.

### Using This Template

For step-by-step instructions on creating a new project using this template, see
our [Project Setup Guide](docs/topics/project-from-template.md).
...
Documentation is automatically built before each commit via pre-commit
hooks.
