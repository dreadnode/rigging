...
- [**Structured Pydantic models**](/open-source/rigging/topics/data-models) can be used interchangeably with unstructured text output.
- LiteLLM as the default generator giving you [**instant access to a huge array of models**](/open-source/rigging/topics/generators).
- Define prompts as python functions with [**type hints and docstrings**](/open-source/rigging/topics/prompt-functions).
- Simple [**tool use**](/open-source/rigging/topics/tools), even for models which don't support them at the API.
- Store different models and configs as [**simple connection strings**](/open-source/rigging/topics/generators#identifiers) just like databases.
- Integrated [**tracing**](/open-source/rigging/topics/tracing) support with [Logfire](https://logfire.pydantic.dev/docs/) to track activity.
- Chat templating, forking, continuations, generation parameter overloads, stripping segments, etc.
- Async batching and fast iterations for [**large scale generation**](/open-source/rigging/topics/iterating-and-batching).
...
2. This is actually shorthand for `litellm!anthropic/claude-3-sonnet-20240229`, where `litellm` is the provider. We just default to that generator and you don't have to be explicit. You can find more information about this in the [generators](/open-source/rigging/topics/generators) docs.
...
Check out [Prompt Functions](/open-source/rigging/topics/prompt-functions) for more information.
...
Check out [Tools](/open-source/rigging/topics/tools) for more information.
...
Check out the **[topics section](/open-source/rigging/topics/workflow)** for more in-depth explanations and examples.
