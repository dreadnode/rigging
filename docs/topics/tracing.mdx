---
title: "Tracing"
description: "Trace all the internal behaviors of rigging with OpenTelemetry."
public: true
---
...
Logfire is capable of reporting trace information to any Open Telemetry compatible system, and provides some convient abstractions on top of the standard open-telemetry-sdk which we like. If the `logfire` package is installed and configured, details about pipelines, prompts, and tools will be traced during rigging use.
...
We've opted to exclude tracing at the generator level in Rigging (for now) and focus on instrumenting higher-order abstractions like pipelines, tools, etc. which are specific to the framework.
...
*1. As of writing, LiteLLM requires this environment var, even if empty and logfire is managing tokens for you*
