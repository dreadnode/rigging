...
You can learn more about the `@prompt` decorator in the [Prompt Functions](/open-source/rigging/topics/prompt-functions) section.
...
<Tip>
Rigging supports both Chat objects (messages with roles in a conversation format), as well as raw text completions. While we use Chat objects in most of our examples, you can check out the [Completions](/open-source/rigging/topics/completions) section to learn more about their feature parity.
</Tip>
...
Learn more about the `ChatPipeline` object in the [Pipelines](/open-source/rigging/topics/pipelines) section.
