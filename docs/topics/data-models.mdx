---
title: "Data Models"
description: "How to define data models for parsing and validating text."
public: true
---
...
The easiest way to approach this overload is to instantiate your model class with some standard values and use `.to_prety_xml()`
